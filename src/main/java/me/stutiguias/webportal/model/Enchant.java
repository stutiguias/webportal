...
public class Enchant {
    ...
    public static WebItemStack EnchantItem(String ench, WebItemStack stack) {
        ...
        for (String enchantString:enchs) {
            if(enchantString.isEmpty()) continue;
            String[] number_level = enchantString.split(",");
            NamespacedKey nk = NamespacedKey.minecraft(number_level[0]);
            Enchantment enchant = Registry.ENCHANTMENT.get(nk);
            ...
            if(stack.getType() == Material.ENCHANTED_BOOK) {
                ...
                if (bookmeta != null)  bookmeta.addStoredEnchant(enchant, level, true);
